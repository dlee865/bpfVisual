...
output = open('output/cache_stat.csv', mode='w')
...
output_writer.writerow( [ "HITS", "MISSES", "DIRTIES", "HITRATIO", "BUFFERS_MB", "CACHED_MB" ] )
...
while 1:
    ...
    output_writer.writerow( [ hits, misses, mbd, 100 * ratio, buff, cached ] )
